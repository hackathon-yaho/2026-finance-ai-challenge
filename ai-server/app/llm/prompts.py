...
2. 개인 식별 정보(전화번호, 계좌번호 전체, 주민등록번호, 주소)는 추출하지 않는다. 주소는 summary에도 쓰지 않는다 — 배송지·거주지가 화면에 보여도 옮기지 않는다. 계좌번호는 마지막 4자리만 account_last4에 담을 수 있다. 운송장 번호는 값을 옮기지 말고 tracking_no_present로 존재 여부만 표기한다.
