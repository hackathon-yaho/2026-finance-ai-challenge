...
| [draft-timeout-needs-headroom.md](draft-timeout-needs-headroom.md) | ✅ **완결** (08-27 AI 회신 / 08-28 백엔드 반영 완료) | 해소 — 원인은 `draft_effort: medium`(12건 17.9초). `low`로 내리고 타임아웃 10 → 25초. 백엔드 `draftRestClient` 30초로 상향·계약 갱신, 재시도 정책 현행 유지, 데모 표식은 로그만 |
